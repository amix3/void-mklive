...
setup_pipewire() {
    PKGS="$PKGS pipewire alsa-pipewire sof-firmware"
...
build_variant() {
    ...
    XORG_PKGS="xorg-minimal xf86-input-evdev xf86-input-libinput xf86-input-vmmouse xf86-input-wacom xorg-video-drivers setxkbmap xauth font-misc-misc terminus-font dejavu-fonts-ttf orca"
    EXTRA_PKGS="htop neovim mpv mpv-mpris intel-media-driver upower power-profiles-daemon libspa-bluetooth wget curl flatpak p7zip dtrx unzip bash-completion git exfat-utils fuse-exfat ntfs-3g bluez ntp gnome-keyring rsync dkms zstd"
    SERVICES="sshd"
    ...
    case $variant in
        ...
        kde)
            ...
            SERVICES="$SERVICES dbus NetworkManager sddm polkitd power-profiles-daemon bluetoothd"
        ;;
        lxde)
